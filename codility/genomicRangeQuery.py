...
# Simple solution. P and Q will have M queries. For M queries, search for A/C/G/T in the substring, then append the appropriate number to results array.
# O(n+m)t | O(m)s. Tbh I'm not sure why this is O(n+m)
def solution(S, P, Q):
    result = []
